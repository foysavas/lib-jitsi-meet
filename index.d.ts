...
declare module '@lyno/lib-jitsi-meet/modules/xmpp/ChatRoom' {
  ...
  export default class ChatRoom extends Listenable {
       ...
       */
      join(password: string, customJoinPresenceExtensions: any): Promise<any>;
      /**
       *
       * @param fromJoin - Whether this is initial presence to join the room.
       * @param customJoinPresenceExtensions - Object of key values to be added to the initial presence only.
       */
      sendPresence(fromJoin: any, customJoinPresenceExtensions: any): void;
       ...
       */
      _initFocus(from: any, mucJid: any): void;
      focusFeatures: any;
      /**
...
declare module '@lyno/lib-jitsi-meet/modules/xmpp/strophe.ping' {
  ...
  export default class PingConnectionPlugin extends PingConnectionPlugin_base {
       ...
       */
      startInterval(remoteJid: any, interval?: number): void;
      intervalId: number;
      /**
